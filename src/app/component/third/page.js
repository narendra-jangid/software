  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#050816] text-white">
      ...
      <motion.div
        ...
        className="fixed left-[-100px] top-[-100px] h-[350px] w-[350px] rounded-full bg-fuchsia-500/20 blur-3xl pointer-events-none"
      />

      <motion.div
        animate={{ x: [0, -30, 0], y: [0, -50, 0] }}
        transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        className="fixed right-[-120px] top-[500px] h-[400px] w-[400px] rounded-full bg-violet-600/20 blur-3xl pointer-events-none"
      />

      <motion.div
        animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }}
        transition={{ duration: 8, repeat: Infinity }}
        className="fixed bottom-[-150px] left-[30%] h-[350px] w-[350px] rounded-full bg-purple-500/10 blur-3xl pointer-events-none"
      />
      ...
      >
        <motion.div
          initial={{ scale: 0.95 }}
          animate={{ scale: 1 }}
          className="mx-auto mt-4 flex max-w-7xl items-center justify-between rounded-2xl border border-white/10 bg-black/40 px-6 py-4 shadow-2xl backdrop-blur-xl"
        >
          ...
          <nav className="hidden md:flex items-center gap-8">
            {["Services", "Projects", "Team", "Contact"].map((item, i) => (
              <motion.a
                ...
                whileHover={{ y: -3 }}
                className="relative text-gray-300 text-sm font-medium group"
              >
                {item}
                <motion.span
                  whileHover={{ width: "100%" }}
                  className="absolute -bottom-2 left-0 h-0.5 w-0 bg-gradient-to-r from-fuchsia-400 to-violet-400"
                />
              </motion.a>
            ))}
          </nav>
          ...
          <div className="flex items-center gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="hidden md:block rounded-xl bg-gradient-to-r from-fuchsia-500 to-violet-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg hover:shadow-fuchsia-500/50"
            >
              Start Project
            </motion.button>
        ...
        <div className="relative mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-16 items-center px-6 py-24">
          ...
          <div className="space-y-8">
            ...
            <ScrollReveal variant={slideInFromLeft}>
              <motion.div className="inline-flex items-center gap-2 rounded-full border border-fuchsia-400/30 bg-fuchsia-400/10 px-4 py-2 text-sm text-fuchsia-300 w-fit">
            ...
            <div className="space-y-4">
              ...
              <ScrollReveal variant={slideInFromRight} index={2}>
                <h1 className="text-6xl md:text-7xl font-black bg-gradient-to-r from-fuchsia-400 to-violet-500 bg-clip-text text-transparent leading-tight">
                  Modern Software
                </h1>
              </ScrollReveal>
            ...
            <ScrollReveal variant={slideInFromLeft} index={5}>
              <motion.div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-7 py-4 bg-gradient-to-r from-fuchsia-500 to-violet-600 rounded-xl font-bold text-white shadow-lg"
                >
                  Get Started
                </motion.button>
                <motion.button
            ...
            <ScrollReveal variant={slideInFromRight}>
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 4, repeat: Infinity }}
                  className="absolute -inset-10 bg-gradient-to-r from-fuchsia-500 to-violet-500 rounded-3xl blur-3xl opacity-30"
                />

                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800 to-slate-900 p-8 shadow-2xl backdrop-blur-xl overflow-hidden"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="text-center mb-20 space-y-6">
            <ScrollReveal variant={slideInFromTop}>
              <p className="text-fuchsia-400 text-sm font-bold">OUR SERVICES</p>
            </ScrollReveal>
            ...
            {services.map((service, i) => (
              <ScrollReveal key={i} variant={slideInFromBottom} index={i}>
                <motion.div
                  ...
                  className="group relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl overflow-hidden cursor-pointer"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/10 via-transparent to-violet-500/10 opacity-0 group-hover:opacity-100 transition-opacity" />
                  ...
                  <div className="relative z-10 space-y-4">
                    ...
                    <motion.div
                      whileHover={{ x: 8 }}
                      className="flex items-center gap-2 text-fuchsia-400 text-sm font-medium mt-6"
                    >
                      Explore <span className="text-lg">→</span>
                    </motion.div>
                  </div>

                  <motion.div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-fuchsia-500/10 blur-3xl group-hover:bg-fuchsia-500/20 transition-all" />
                </motion.div>
              </ScrollReveal>
            ))}
          </motion.div>
      ...
      <section id="projects" className="py-28 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="text-center mb-20 space-y-6">
            <ScrollReveal variant={slideInFromTop}>
              <p className="text-fuchsia-400 text-sm font-bold">OUR WORK</p>
            </ScrollReveal>
            ...
            {projects.map((project, i) => (
              <ScrollReveal key={i} variant={slideInFromBottom} index={i}>
                <ParallaxSection offset={20}>
                  <motion.div
                    whileHover={{ y: -12 }}
                    className="group overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl"
                  >
                    <motion.div
                    ...
                    <div className="p-8 space-y-4">
                      ...
                      <motion.button
                        whileHover={{ x: 8 }}
                        className="text-fuchsia-400 text-sm font-bold flex items-center gap-2"
                      >
      ...
      <section id="about" className="py-28 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <ScrollReveal variant={slideInFromLeft}>
            <div className="space-y-8">
              <div>
                <p className="text-fuchsia-400 text-sm font-bold mb-4">WHY CHOOSE US</p>
                <SplitText
                ...
                {[
                  ...
                  <ScrollReveal key={i} variant={slideInFromLeft} index={i}>
                    <motion.div
                      ...
                      className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl cursor-pointer"
                    >
          ...
          <ParallaxSection offset={-30}>
            <ScrollReveal variant={slideInFromRight}>
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="rounded-3xl border border-white/10 bg-gradient-to-br from-fuchsia-500/10 to-violet-500/10 p-12 backdrop-blur-xl"
              >
                <motion.div
                  initial="hidden"
                  whileInView="visible"
                ...
                >
                  {[
                    ...
                    <ScrollReveal key={i} variant={scaleInVariant} index={i}>
                      ...
                      >
                        <h3 className="text-4xl font-black text-fuchsia-400">{num}</h3>
      ...
      <section id="team" className="py-28 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="text-center mb-20 space-y-6">
            <ScrollReveal variant={slideInFromTop}>
              <p className="text-fuchsia-400 text-sm font-bold">OUR TEAM</p>
            </ScrollReveal>
          ...
          >
            {teamMembers.map((member, i) => (
              <ScrollReveal key={i} variant={slideInFromBottom} index={i}>
                <motion.div
                  whileHover={{ y: -12 }}
                  className="group relative rounded-2xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-xl overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/10 via-transparent to-violet-500/10 opacity-0 group-hover:opacity-100 transition-opacity" />
                  ...
                  <div className="relative z-10 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-fuchsia-400 text-sm mt-1">{member.role}</p>
                    </div>
                    ...
                    >
                      {["in", "gh", "tw"].map((social, j) => (
                        <motion.button
                          ...
                          className="h-8 w-8 rounded-lg border border-white/10 bg-white/5 text-xs font-bold text-gray-300 hover:border-fuchsia-400/40 hover:bg-fuchsia-500/10 hover:text-fuchsia-400 transition-all"
                        >
                          {social}
                        </motion.button>
                      ))}
                  ...
                  <motion.div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-fuchsia-500/10 blur-3xl" />
                </motion.div>
              </ScrollReveal>
            ))}
          </motion.div>
      ...
      <section id="testimonials" className="py-28 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="text-center mb-20">
            <ScrollReveal variant={slideInFromTop}>
              <p className="text-fuchsia-400 text-sm font-bold">TESTIMONIALS</p>
            </ScrollReveal>
      ...
      <section id="contact" className="py-28 px-6">
        <ScrollReveal variant={scaleInVariant}>
          <div className="max-w-5xl mx-auto rounded-3xl border border-white/10 bg-gradient-to-br from-fuchsia-500/10 to-violet-500/10 p-12 md:p-20 text-center backdrop-blur-xl overflow-hidden relative">
            <motion.div
              animate={{ scale: [1, 1.3, 1], opacity: [0.3, 0.6, 0.3] }}
              transition={{ duration: 8, repeat: Infinity }}
              className="absolute -top-32 -right-32 w-64 h-64 rounded-full bg-fuchsia-500/20 blur-3xl"
            />
              ...
              <ScrollReveal variant={slideInFromBottom} index={2}>
                <motion.div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 bg-gradient-to-r from-fuchsia-500 to-violet-600 rounded-xl font-bold text-white shadow-lg"
                  >
                    Contact Us
                  </motion.button>
                  <motion.button
      ...
      <footer className="relative border-t border-white/10 bg-black/20 py-20 backdrop-blur-xl overflow-hidden">
        <motion.div
          ...
          transition={{ duration: 8, repeat: Infinity }}
          className="absolute left-0 top-0 h-64 w-64 rounded-full bg-fuchsia-500/10 blur-3xl"
        />
            ...
            <ScrollReveal variant={slideInFromBottom} className="lg:col-span-2">
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-fuchsia-500 to-violet-600 flex items-center justify-center text-white font-bold">
                    T
                  </div>
                  <div>
                ...
                >
                  {["LinkedIn", "GitHub", "Twitter", "Dribbble"].map((item, i) => (
                    <motion.a
                      ...
                      variants={fadeUp}
                      whileHover={{ y: -3 }}
                      className="text-xs px-3 py-2 rounded-lg border border-white/10 bg-white/5 hover:border-fuchsia-400/40 hover:bg-fuchsia-500/10 hover:text-fuchsia-400 transition-all"
                    >
                      {item}
                    </motion.a>
                  ))}
                  ...
                  >
                    {col.links.map((link) => (
                      <motion.a
                        ...
                        variants={revealText}
                        whileHover={{ x: 5 }}
                        className="text-sm text-gray-400 hover:text-fuchsia-400 transition-colors block"
                      >
                        {link}
                      </motion.a>
                    ))}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-white placeholder:text-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-400"
                  />
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-4 py-2 rounded-lg bg-gradient-to-r from-fuchsia-500 to-violet-600 text-white font-bold text-sm hover:shadow-lg transition-all"
                  >
                    Subscribe
                  </motion.button>
                </div>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
            ...
            <div className="flex gap-6">
              {["Privacy Policy", "Terms of Service", "Cookies"].map((link) => (
                <motion.a key={link} href="#" whileHover={{ color: "#d946ef" }} className="hover:text-fuchsia-400 transition-colors">
                  {link}
                </motion.a>
              ))}
            </div>
